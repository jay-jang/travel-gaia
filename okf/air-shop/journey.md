...
# Distinctions
- **Journey** vs [Origin & Destination](/air-shop/origin-destination.md) — A journey is the whole trip; an O&D is a single directional point-pair, and a journey may contain several O&Ds.
- **Journey** vs [Segment](/air-ops/segment.md) — A segment is one priced/booked flight portion within a journey; the journey is the full set of segments end to end.
