...
# Distinctions
- **Negotiated Fare** vs [Fare Rule](/air-shop/fare-rule.md) — Fare Rule is the general framework of numbered ATPCO categories; Negotiated Fare is the specific construct governed by one of them (Category 35), covering private/contract fares and their ticketing security.
- **Negotiated Fare** vs [Fare Basis Code](/air-shop/fare-basis-code.md) — A fare basis code labels any fare, public or private; Negotiated Fare specifically denotes a privately filed Category 35 fare restricted to authorized sellers, often invisible in neutral public displays.
