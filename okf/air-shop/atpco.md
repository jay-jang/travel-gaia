...
# Distinctions
- **ATPCO** vs [GDS](/standards/gds.md) — ATPCO supplies and processes fare/rule data; a GDS distributes inventory and bookings and consumes ATPCO data for pricing.
- **ATPCO** vs [Fare Basis Code](/air-shop/fare-basis-code.md) — ATPCO is the organization/data source; the fare basis code is one data element it distributes.
