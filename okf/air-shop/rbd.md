...
# Distinctions
- **RBD** vs [Fare Basis Code](/air-shop/fare-basis-code.md) — The RBD is the single booking-class letter; the fare basis code is the longer alphanumeric string identifying the full fare, usually starting with the RBD.
- **RBD** vs [Availability](/air-shop/availability.md) — RBD is the class identifier; availability is the seat count sellable in that RBD.
