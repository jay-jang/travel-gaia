# Air — Shopping, Pricing & Availability

RBD, fare basis, availability — air shopping & pricing concepts.
...
* [Fare Family](fare-family.md) - A fare family is a marketed bundle of a fare together with a defined set of attributes and ancillaries (such as baggage, seat selection, cha
* [Fare Rule](fare-rule.md) - A Fare Rule is the set of conditions and restrictions that govern when and how a published fare may be sold, ticketed, and used.
* [Journey](journey.md) - A journey is the complete travel a passenger undertakes from the point of origin to final destination, including all flights and any return 
* [Maximum Permitted Mileage (MPM)](maximum-permitted-mileage.md) - Maximum Permitted Mileage (MPM) is the maximum distance a passenger may travel between two points on a given published through-fare without 
* [Negotiated Fare](negotiated-fare.md) - A negotiated fare is a private or contract fare offered to a specific channel (such as a consolidator, corporation, or agency) rather than p
* [NUC](nuc.md) - NUC (Neutral Unit of Construction) is a common, currency-neutral unit used in international fare construction to add and compare fare compon
* [Optional Services](optional-services.md) - Optional Services is ATPCO's dedicated product and data filing through which airlines file, price, and distribute paid and free ancillaries 
* [Origin & Destination](origin-destination.md) - Origin & Destination (O&D) is the city or airport pair representing where a passenger's journey or priced portion begins and ends, irrespect
* [Origin & Destination Control (O&D Control)](origin-destination-control.md) - Origin & Destination Control (O&D control) is a network revenue-management method that values each seat by the contribution of the passenger
* [Overbooking](overbooking.md) - Overbooking is the deliberate practice of selling more seats on a flight than the aircraft physically has, to offset expected no-shows and c
* [Pricing Unit](pricing-unit.md) - A Pricing Unit is a journey or portion of a journey that is priced as a single entity, made up of one or more fare components.
