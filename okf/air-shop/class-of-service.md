...
# Distinctions
- **Class of Service** vs [RBD](/air-shop/rbd.md) — RBD (Reservation Booking Designator) is the formal name for the inventory class code; Class of Service is the more colloquial term for the same concept, though it is sometimes loosely used to mean the marketing cabin.
