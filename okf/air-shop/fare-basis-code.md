...
# Distinctions
- **Fare Basis Code** vs [RBD](/air-shop/rbd.md) — The RBD is a single booking-class letter; the fare basis code is the full alphanumeric fare identifier that usually starts with that letter.
- **Fare Basis Code** vs [Fare Family](/air-shop/fare-family.md) — A fare basis identifies one specific filed fare; a fare family is a marketing bundle that may span multiple fare basis codes.
