...
# Distinctions
- **Availability** vs [RBD](/air-shop/rbd.md) — RBD is the class code; availability is the number of seats sellable in that RBD.
- **Availability** vs [Overbooking](/air-shop/overbooking.md) — Overbooking can make availability exceed physical capacity by selling above the seat count.
