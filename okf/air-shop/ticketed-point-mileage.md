...
# Related
- [Maximum Permitted Mileage (MPM)](/air-shop/maximum-permitted-mileage.md) — related
...
# Distinctions
- **Ticketed Point Mileage (TPM)** vs [Maximum Permitted Mileage (MPM)](/air-shop/maximum-permitted-mileage.md) — TPM is the actual flown distance per coupon; MPM is the maximum allowed distance for a through-fare's O&D. The mileage system compares summed TPM against MPM.
- **Ticketed Point Mileage (TPM)** vs [Proration](/air-partner/proration.md) — TPM is a distance datum; proration is the process of splitting interline revenue, which can use TPM-derived mileage factors as one prorate basis.
