...
# Related
- [Fare Component](/air-shop/fare-component.md) — parent
- [Fare Construction](/air-shop/fare-construction.md) — related
- [Journey](/air-shop/journey.md) — related
- [NUC](/air-shop/nuc.md) — related

# Distinctions
- **Pricing Unit** vs [Fare Component](/air-shop/fare-component.md) — A Fare Component is a single fare and the flights it covers; a Pricing Unit groups one or more fare components into the entity that is actually priced and rule-checked together.
- **Pricing Unit** vs [Journey](/air-shop/journey.md) — A Journey is the whole travel from start to end; a Pricing Unit is a sub-portion of the journey priced as one entity, and a journey may contain several pricing units.
