...
# Distinctions
- **Release Period** vs [Allotment](/lodging/hotel-rate/allotment.md) — An Allotment is the block of rooms held for a partner; the Release Period is the rule defining how many days before arrival the unsold portion of that allotment is given back to the hotel.
- **Release Period** vs [Cutoff Date](/lodging/hotel-rate/cutoff-date.md) — Release Period is the general lead time before arrival at which any held inventory (e.g., an allotment) reverts to the supplier; the cutoff date is the specific contracted calendar date that triggers this for a particular group block.
