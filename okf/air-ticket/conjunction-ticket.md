...
# Distinctions
- **Conjunction Ticket** vs [Flight Coupon](/air-ticket/flight-coupon.md) — A flight coupon is one segment-level portion of a single ticket; a conjunction ticket is a grouping of multiple whole tickets, used when an itinerary needs more coupons than one ticket can hold.
