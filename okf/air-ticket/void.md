...
- [Refund](/air-ticket/refund.md) — contrasts
- [BSP](/pay/bsp.md) — related
- [ARC](/pay/arc.md) — related

# Distinctions
- **Void** vs [Refund](/air-ticket/refund.md) — Void reverses an issuance within the same sales period so it is never billed; refund returns value after the document has been reported/settled.
- **Void** vs [Reissue](/air-ticket/reissue.md) — Void nullifies the document entirely; reissue keeps the value and exchanges it for a new document.

# Citations
[1] IATA — BSP / ARC sales reporting and void procedures
