...
# Distinctions
- **Penalty Fee** vs [Residual Value](/air-ticket/residual-value.md) — A penalty fee is a charge deducted during a change or refund; residual value is the surplus that may remain after the penalty and fare difference are applied in an exchange.
