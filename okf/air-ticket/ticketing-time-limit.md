...
# Distinctions
- **Ticketing Time Limit** vs [Queue](/air-ops/queue.md) — A queue is the GDS workflow bucket where pending-ticketing PNRs are placed; the ticketing time limit is the deadline itself.
