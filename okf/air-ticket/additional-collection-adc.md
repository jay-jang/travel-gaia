...
- [Exchange](/air-ticket/exchange.md) — related
- [Residual Value](/air-ticket/residual-value.md) — contrasts
- [Penalty Fee](/air-ticket/penalty-fee.md) — related
- [Form of Payment](/pay/form-of-payment.md) — related

# Distinctions
- **Additional Collection (ADC)** vs [Residual Value](/air-ticket/residual-value.md) — ADC is collected when the new itinerary is worth more than the original (passenger pays the difference); Residual Value arises when the new itinerary is worth less (value is left over). They are the two opposite outcomes of an exchange.
- **Additional Collection (ADC)** vs [Penalty Fee](/air-ticket/penalty-fee.md) — A penalty fee is the change/cancellation charge defined by the fare rule; the ADC is the total amount actually collected, which typically includes the fare and tax difference plus that penalty.
