...
- [Voluntary Changes (ATPCO Category 31)](/air-ticket/voluntary-changes-atpco-category-31.md) — related
- [Penalty Fee](/air-ticket/penalty-fee.md) — related

# Distinctions
- **Voluntary Refunds (ATPCO Category 33)** vs [Voluntary Changes (ATPCO Category 31)](/air-ticket/voluntary-changes-atpco-category-31.md) — Category 33 governs voluntary refunds (returning value and cancelling travel); Category 31 governs voluntary changes (reissuing the ticket for new travel). They are separate sibling categories.
- **Voluntary Refunds (ATPCO Category 33)** vs [Refund](/air-ticket/refund.md) — Refund is the outcome of returning value to the passenger; Category 33 is the ATPCO rule data that machine-determines whether and how much of a voluntary refund is due.
