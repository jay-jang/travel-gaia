...
- [Void](/air-ticket/void.md) — contrasts
- [Reissue](/air-ticket/reissue.md) — contrasts
- [BSP](/pay/bsp.md) — related
- [ARC](/pay/arc.md) — related

# Distinctions
- **Refund** vs [Void](/air-ticket/void.md) — Void cancels an issuance within the same sales period at zero cost; a refund returns value after the sales/void window, typically with applicable penalties.
- **Refund** vs [Reissue](/air-ticket/reissue.md) — Refund returns value to the customer; reissue exchanges the ticket for new transportation.
- **Refund** vs [Chargeback](/pay/chargeback.md) — A refund is a merchant-initiated return of funds; a chargeback is a cardholder-initiated dispute forced through the card network.
