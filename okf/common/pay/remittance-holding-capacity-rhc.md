...
- **Remittance Holding Capacity (RHC)** vs [NewGen ISS](/common/pay/newgen-iss.md) — RHC is one risk-management control introduced by NewGen ISS (a cap on outstanding cash sales); NewGen ISS is the broader umbrella program that also defines the three accreditation models and TIP.
