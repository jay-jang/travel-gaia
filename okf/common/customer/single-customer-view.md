...
# Distinctions
- **Single Customer View** vs [Customer Profile](/common/customer/customer-profile.md) — A Customer Profile is one system's stored view of a traveler and may be duplicated or partial; the Single Customer View is the de-duplicated golden record consolidating all such profiles into one authoritative identity.
