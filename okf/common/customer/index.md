...
* [IATA One ID](iata-one-id.md) - An IATA initiative and standards framework enabling a contactless, document-free passenger journey based on a single, reusable digital ident
* [Known Traveler Number](known-traveler-number.md) - A Known Traveler Number (KTN) is a unique identifier issued by the U.S.
* [Loyalty Tier Status](loyalty-tier-status.md) - The graded level a member holds within a Frequent Flyer Program (e.g.
* [Mileage Accrual](mileage-accrual.md) - Mileage accrual is the process by which a frequent flyer program member earns and accumulates miles or points into their loyalty account.
* [Name Change](name-change.md) - Altering the passenger name on a booking or ticket, ranging from a minor spelling correction to substituting a different traveler.
* [Passenger Type Code](passenger-type-code.md) - A standardized code (typically three alphanumeric characters, e.g.
* [PRM](prm.md) - A Passenger with Reduced Mobility — any person whose mobility is reduced due to physical or mental disability, age, illness or other cause a
* [Redress Number](redress-number.md) - A Redress Number is a unique identifier issued by the U.S.
* [RFM Segmentation](rfm-segmentation.md) - A quantitative customer-segmentation method that scores each traveler on three behavioral dimensions — Recency (how recently they transacted
* [Secure Flight](secure-flight.md) - A US Transportation Security Administration (TSA) program that prescreens passengers on covered flights against government watch lists.
* [Single Customer View](single-customer-view.md) - A single, deduplicated, authoritative record per customer — the 'golden record' — assembled by matching and merging data about the same indi
* [Status Match](status-match.md) - A loyalty-acquisition mechanism in which an airline or hotel program grants a member of a competing program an equivalent elite tier, on pro
* [Transfer Partner](transfer-partner.md) - A loyalty or financial program with which a points/miles currency holder has an affiliation allowing balances to be moved into the partner's
* [Traveler Preference](traveler-preference.md) - A traveler preference is a stored, non-mandatory attribute describing how a traveler prefers to be served, such as seat choice (aisle/window
* [Unaccompanied Minor](unaccompanied-minor.md) - An Unaccompanied Minor (UMNR) is a child travelling by air without an accompanying parent, legal guardian, or responsible adult aged 18 or o
