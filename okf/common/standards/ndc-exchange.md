...
# Distinctions
- **NDC Exchange** vs [Aggregator](/common/standards/aggregator.md) — An aggregator is the general category of supplier-content consolidator; NDC Exchange is a specific ATPCO/SITA industry hub that also normalizes and translates NDC and OTA schema versions between parties.
- **NDC Exchange** vs [NDC](/common/standards/ndc.md) — NDC is the messaging standard; NDC Exchange is a connectivity platform/marketplace that carries, normalizes, and translates NDC (and other) messages between airlines and sellers.
