...
distinctions:
  ...
  - targetTerm: Dynamic Currency Conversion (DCC)
...
# Distinctions
- **ISO 4217 Currency Code** vs [NUC](/air/air-shop/nuc.md) — ISO 4217 codes denote real-world currencies; NUC is a fare-construction neutral unit used internally to convert fares between currencies, not an ISO 4217 currency.
- **ISO 4217 Currency Code** vs [Dynamic Currency Conversion (DCC)](/common/pay/dynamic-currency-conversion-dcc.md) — ISO 4217 is the standard that names and codes currencies; DCC is a commercial point-of-sale conversion service that chooses which currency the cardholder is billed in.
