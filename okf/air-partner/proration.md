...
# Distinctions
- **Proration** vs [SPA (Special Prorate Agreement)](/air-partner/spa-special-prorate-agreement.md) — Proration is the general allocation process; an SPA is a specific bilateral agreement supplying special values used in that process.
- **Proration** vs [Fare Component](/air-shop/fare-component.md) — A fare component is a priced portion of an itinerary; proration is the act of splitting that fare's value among the carriers operating it.
