...
# Distinctions
- **Schedule Change** vs [IROPS](/air-partner/irops.md) — Schedule change is a planned amendment to the published schedule communicated in advance; IROPS is unplanned day-of-operations disruption (delays, cancellations, diversions).
- **Schedule Change** vs [Involuntary Reissue](/air-ticket/involuntary-reissue.md) — Schedule change is the triggering event; involuntary reissue is the resulting ticket action to reaccommodate the passenger at no additional fare.
