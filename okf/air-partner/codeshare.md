...
# Distinctions
- **Codeshare** vs [Interline](/air-partner/interline.md) — Codeshare puts the marketing carrier's own code on another carrier's flight; interline is acceptance of another carrier's ticket without the marketing carrier's code on the flight.
- **Codeshare** vs [Operating Carrier](/air-partner/operating-carrier.md) — Codeshare is the agreement/arrangement, while the operating carrier is the airline actually flying the aircraft.
