...
- [Admission](/rail/admission.md) — child
- [Seat Reservation](/rail/seat-reservation.md) — child
- [Fulfillment (Rail)](/rail/fulfillment-rail.md) — child
...
- [Multimodal Transport](/rail/multimodal-transport.md) — related
- [REST API](/standards/rest-api.md) — related

# Distinctions
- **OSDM** vs [NDC](/standards/ndc.md) — OSDM is the UIC open standard for rail (and multimodal) offer/booking/fulfillment; NDC is IATA's equivalent XML standard for air. They are sibling distribution standards in different modes, sharing an offer/order philosophy.
- **OSDM** vs [TAP TSI](/rail/tap-tsi.md) — OSDM is a voluntary open API/data-model standard for commercial distribution; TAP TSI is the EU legal regulation mandating interoperable interfaces. OSDM is one concrete way to implement the retail interfaces that TAP TSI prescribes.
