...
# Distinctions
- **Fulfillment (Rail)** vs [E-ticket](/air-ticket/e-ticket.md) — Rail fulfillment is the OSDM concept of realizing a controllable ticket from a booking; the air E-ticket is one specific issued document. Rail fulfillment commonly relies on a barcode/control number rather than a GDS-style ticket coupon.
- **Fulfillment (Rail)** vs [Flexible Content Barcode (FCB)](/rail/flexible-content-barcode-fcb.md) — FCB is the barcode technology that carries the contract; fulfillment is the broader lifecycle step of producing and controlling the travel document, which may use FCB.
