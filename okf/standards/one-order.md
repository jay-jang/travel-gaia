...
- [PNR](/air-ops/pnr.md) — replaces
- [E-ticket](/air-ticket/e-ticket.md) — replaces
- [EMD](/air-ticket/emd.md) — replaces

# Distinctions
- **ONE Order** vs [NDC](/standards/ndc.md) — ONE Order standardizes the single post-sale Order record and its management; NDC standardizes the shopping/offer and booking messaging that creates it.
- **ONE Order** vs [Order](/standards/order.md) — ONE Order is the IATA standard/initiative; Order is the underlying single-record data object it defines and promotes.
- **ONE Order** vs [E-ticket](/air-ticket/e-ticket.md) — ONE Order's single Order record is designed to replace document-based e-tickets (and EMDs) with order-level accounting and fulfillment.
