...
# Distinctions
- **Shopping API** vs [Availability](/air-shop/availability.md) — Availability indicates whether seats/classes are sellable; a Shopping API returns constructed, priced Offers built on top of that availability.
- **Shopping API** vs [Offer](/standards/offer.md) — An Offer is the priced proposal object; the Shopping API is the request/response interface used to obtain Offers during search.
