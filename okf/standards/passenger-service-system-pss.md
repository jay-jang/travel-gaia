...
# Related
- [Order Management System (OMS)](/standards/order-management-system-oms.md) — related
...
# Distinctions
- **Passenger Service System (PSS)** vs [CRS](/hotel-dist/crs.md) — A CRS (reservations system) is one component within a PSS; the PSS is the broader platform that also includes inventory and departure control alongside reservations.
- **Passenger Service System (PSS)** vs [Order Management System (OMS)](/standards/order-management-system-oms.md) — The PSS is the legacy PNR/ticket-centric platform; an OMS is the modern order-centric system that progressively replaces PSS functions in offer-and-order retailing.

# Citations
[1] IATA — Offers and Orders Transformation Strategic Partnerships Program
[2] Wikipedia — Passenger service system
