...
# Related
- [EDIFACT](/standards/edifact.md) — contrasts
- [NDC](/standards/ndc.md) — related
- [Shopping API](/standards/shopping-api.md) — related
- [Direct Connect](/standards/direct-connect.md) — related
- [Aggregator](/standards/aggregator.md) — related

# Distinctions
- **REST API** vs [EDIFACT](/standards/edifact.md) — A REST API is a modern HTTP/JSON web-service style; EDIFACT is a legacy compact-text EDI syntax used in classic GDS/PSS messaging.
- **REST API** vs [NDC](/standards/ndc.md) — REST is a transport/architectural style; NDC is a domain data standard whose messages may be carried over SOAP/XML or REST/JSON.

# Citations
[1] IETF / W3C — REST architectural style (HTTP)
