...
- [Fare Family](/air-shop/fare-family.md) — related
- [OpenTravel Alliance](/standards/opentravel-alliance.md) — contrasts

# Distinctions
- **NDC** vs [GDS Bypass](/standards/gds-bypass.md) — NDC is the XML-based data transmission standard; GDS Bypass is a strategic routing decision that often uses NDC.
- **NDC** vs [GDS](/standards/gds.md) — NDC is a messaging standard for distributing content; a GDS is a distribution platform that may carry NDC or legacy content.
- **NDC** vs [OpenTravel Alliance](/standards/opentravel-alliance.md) — NDC is IATA's air-distribution XML standard; OpenTravel is a separate, broader cross-sector travel XML schema body.
- **NDC** vs [ONE Order](/standards/one-order.md) — NDC standardizes shopping/booking offers and orders; ONE Order standardizes the single customer order record that replaces PNR/e-ticket/EMD.
