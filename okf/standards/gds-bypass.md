...
# Distinctions
- **GDS Bypass** vs [GDS](/standards/gds.md) — GDS is the intermediary being bypassed; GDS Bypass is the strategy of routing around it.
- **GDS Bypass** vs [Direct Connect](/standards/direct-connect.md) — Direct Connect is the technical API link; GDS Bypass is the business strategy that utilizes it.

# Citations
[1] IATA — IATA New Distribution Capability (NDC) Implementation Guide
