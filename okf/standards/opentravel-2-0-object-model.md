...
# Related
- [OpenTravel Alliance](/standards/opentravel-alliance.md) — parent
- [REST API](/standards/rest-api.md) — related
- [NDC](/standards/ndc.md) — related

# Distinctions
- **OpenTravel 2.0 Object Model** vs [OpenTravel Alliance](/standards/opentravel-alliance.md) — The OpenTravel Alliance is the standards organization; the 2.0 Object Model is the specific next-generation object-oriented specification that body publishes, succeeding its legacy 1.x XML message set.
- **OpenTravel 2.0 Object Model** vs [NDC](/standards/ndc.md) — OpenTravel 2.0 is a broad multi-sector travel object model; NDC is IATA's air-specific offer-and-order distribution standard.
