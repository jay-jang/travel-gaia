...
# Distinctions
- **Offer** vs [Order](/standards/order.md) — An Offer is a non-binding priced proposal before purchase; an Order is the committed record created when the customer accepts an Offer.
- **Offer** vs [Availability](/air-shop/availability.md) — Availability indicates whether seats/classes are sellable; an Offer is a constructed, priced bundle proposal built on top of availability.
