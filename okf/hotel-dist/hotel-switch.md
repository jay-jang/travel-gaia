...
- [Two-Way XML](/hotel-dist/two-way-xml.md) — related
- [GDS](/standards/gds.md) — related
- [Bedbank](/hotel-dist/bedbank.md) — contrasts

# Distinctions
- **Hotel Switch** vs [Channel Manager](/hotel-dist/channel-manager.md) — A channel manager is the hotel-side tool a single property uses to manage its rates and inventory across channels; a switch is the neutral many-to-many routing layer that connects CRS/PMS systems to large distribution networks. Channel managers often connect to channels via switches.
- **Hotel Switch** vs [Bedbank](/hotel-dist/bedbank.md) — A bedbank buys and resells hotel inventory at net rates, taking a commercial position; a switch never owns inventory or sets prices and only transports messages.
