...
# Distinctions
- **Distribution Cost** vs [Commissionable Rate](/hotel-dist/commissionable-rate.md) — A commissionable rate is the specific rate type on which a fixed agency commission is paid; distribution cost is the broader total-cost metric aggregating commissions plus all other channel fees and indirect costs.
