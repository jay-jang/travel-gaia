...
# Related
- [Allotment](/hotel-rate/allotment.md) — contrasts
...
# Distinctions
- **Free Sale** vs [Allotment](/hotel-rate/allotment.md) — Free sale lets a channel confirm bookings without checking a finite block (subject to stop-sell); an allotment is a fixed pre-allocated number of rooms a channel may sell.
- **Free Sale** vs [Overbooking](/air-shop/overbooking.md) — Free sale is a selling mechanism that can lead to overbooking if stop-sell is delayed; overbooking is the resulting state of having sold more rooms than available.
