...
# Distinctions
- **Booking Engine** vs [CRS](/hotel-dist/crs.md) — The CRS is the central system that holds and distributes a hotel's inventory and rates across all channels; the booking engine is the guest-facing front end of the direct channel that queries the CRS and creates direct reservations.
- **Booking Engine** vs [Channel Manager](/hotel-dist/channel-manager.md) — A channel manager distributes ARI outbound to many third-party channels; the booking engine sells inbound on the hotel's own direct channel. They are complementary, not the same.
