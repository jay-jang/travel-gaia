...
# Distinctions
- **CRS** vs [PMS](/hotel-dist/pms.md) — CRS manages distribution and central reservations; PMS manages on-property operations like check-in, folios, and housekeeping.
- **CRS** vs [Channel Manager](/hotel-dist/channel-manager.md) — CRS is the central inventory/reservation hub; a Channel Manager is the connectivity layer that syncs ARI to many online channels (sometimes a CRS feature, sometimes a separate product).
