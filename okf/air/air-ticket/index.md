# Air — Ticketing & Orders

E-tickets, EMD, reissue/refund and the Order domain.

* [Additional Collection (ADC)](additional-collection-adc.md) - Additional Collection (ADC) is the difference-in-fare-and-tax amount collected from the passenger when a ticket is reissued or exchanged for
* [Agency Credit Memo (ACM)](agency-credit-memo-acm.md) - An Agency Credit Memo (ACM) is the accounting notice an airline issues to credit a travel agent - for example to return over-collected fares
* [Agency Debit Memo (ADM)](agency-debit-memo-adm.md) - An Agency Debit Memo (ADM) is an accounting notice issued by an airline to a travel agent to claim an amount owed in connection with the iss
* [Ancillary Service](ancillary-service.md) - A chargeable product or service sold by an airline in addition to the base air transportation, such as paid checked baggage, advance seat se
* [Conjunction Ticket](conjunction-ticket.md) - A conjunction ticket is a set of two or more tickets issued together and cross-referenced to a passenger, which together constitute a single
...
* [Involuntary Reissue](involuntary-reissue.md) - A reissue caused by circumstances attributable to the carrier such as a schedule change, flight cancellation, or IROPS, rather than by passe
* [MCO (Miscellaneous Charges Order)](mco-miscellaneous-charges-order.md) - A Miscellaneous Charges Order (MCO) is an accountable traffic document used to record the prepayment or collection of charges that are not f
* [Open Ticket](open-ticket.md) - An open ticket is a ticket on which one or more flight coupons have no fixed flight, date, or time — the coupon is issued with an OPEN statu
* [Penalty Fee](penalty-fee.md) - A penalty fee is a charge imposed under a fare's rules when a ticket is changed (reissued/exchanged) or cancelled/refunded, over and above a
* [Reason for Issuance Code / Sub Code (RFIC / RFISC)](rfic-rfisc.md) - Every EMD carries a one-character IATA Reason for Issuance Code (RFIC, groups A-G) that classifies the broad nature of the charge, plus a th
...
* [Voluntary Refunds (ATPCO Category 33)](voluntary-refunds-atpco-category-33.md) - ATPCO Fare Rule Category 33 is the machine-readable rule set defining the conditions and applicable charges under which voluntary refunds of
