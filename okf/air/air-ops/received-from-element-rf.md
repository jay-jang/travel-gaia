...
# Distinctions
- **Received From Element (RF)** vs [OSI](/air/air-ops/osi.md) — The Received From element is a mandatory internal PNR field recording who authorized a change; an OSI is an optional informational message sent to carriers and is unrelated to change accountability.
