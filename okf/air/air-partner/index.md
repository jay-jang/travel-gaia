# Air — Codeshare, Interline & Schedules

Codeshare, interline, marketing/operating carriers — airline partnerships.

* [Airline Alliance](airline-alliance.md) - A long-term commercial cooperation among multiple airlines that pools networks, frequent-flyer programs, lounges, and customer benefits unde
* [Antitrust Immunity](antitrust-immunity.md) - A regulatory grant—issued in the US by the Department of Transportation (DOT), with equivalents from other competition authorities—that lega
* [Block Space Agreement](block-space-agreement.md) - A codeshare arrangement in which a marketing carrier purchases a fixed block of seats on an operating carrier's flight to resell under its o
...
* [Joint Venture](joint-venture.md) - A deep commercial cooperation in which two or more airlines coordinate pricing, scheduling, capacity, and marketing on defined markets (ofte
...
* [Schedule Change](schedule-change.md) - A change made by an airline to a previously published flight schedule, such as a revised departure or arrival time, equipment change, flight
* [Slot](slot.md) - A permission allocated to an airline to operate an aircraft arrival or departure at a specific date and time at a capacity-constrained (coor
* [SPA (Special Prorate Agreement)](spa-special-prorate-agreement.md) - A bilateral agreement between two airlines that establishes special, negotiated proration values (the share of fare each carrier receives) f
* [Standard Schedules Message](standard-schedules-message.md) - The IATA-standard message format (defined in the Standard Schedules Information Manual, SSIM Chapter 4) by which an airline distributes perm
* [Through Fare](through-fare.md) - A single published fare covering carriage between an origin and a final destination over the whole journey, including any intermediate conne
* [Wet Lease](wet-lease.md) - An aircraft lease in which the lessor provides the aircraft together with crew, maintenance, and insurance (ACMI) and operates it under the 
