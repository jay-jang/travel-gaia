...
# Related
- [ACRISS Code](/car/acriss-code.md) — related
...
# Distinctions
- **Car Class** vs [ACRISS Code](/car/acriss-code.md) — An ACRISS code is a standardized four-letter descriptor of a vehicle's attributes; a car class is the supplier's sellable grouping (with rates and availability) built from one or more such codes and booked as 'or similar'.
