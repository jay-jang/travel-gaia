...
# Distinctions
- **Embarkation** vs [Port of Call](/cruise/cruise/port-of-call.md) — Embarkation happens once, at the home port that opens the voyage; ports of call are the intermediate stops where guests go ashore and reboard the same ship without checking in anew.
- **Embarkation** vs [Muster Drill](/cruise/cruise/muster-drill.md) — Embarkation is the overall boarding/check-in process; the muster drill is one mandatory safety step within it that SOLAS requires before or at departure.
