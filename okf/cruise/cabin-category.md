...
# Related
- [Room Type](/hotel-rate/room-type.md) — sameAs
- [Guarantee Cabin (GTY)](/cruise/guarantee-cabin-gty.md) — related
- [Single Supplement](/cruise/single-supplement.md) — related
- [Availability](/air-shop/availability.md) — related
- [Revenue Management](/air-shop/revenue-management.md) — related

# Distinctions
- **Cabin Category** vs [Room Type](/hotel-rate/room-type.md) — Cabin Category is the cruise term for the same concept as a hotel Room Type — a graded physical product against which a rate is quoted — but cruise categories are typically far more numerous and finely graded (often dozens of sub-categories) and are priced per person on double occupancy rather than per room.
- **Cabin Category** vs [Guarantee Cabin (GTY)](/cruise/guarantee-cabin-gty.md) — A cabin category is the named grade itself; a Guarantee (GTY) is a booking method that locks a guaranteed minimum category while deferring assignment of the specific cabin within or above it.
