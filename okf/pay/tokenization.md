...
# Related
- [PCI DSS](/pay/pci-dss.md) — related
- [VCC](/pay/vcc.md) — related
- [Merchant of Record](/pay/merchant-of-record.md) — related
- [Acquirer](/pay/acquirer.md) — related

# Distinctions
- **Tokenization** vs [VCC](/pay/vcc.md) — A VCC is a real, spendable virtual card number generated for a specific payment (often B2B supplier settlement), while a token is a non-spendable surrogate that maps back to an existing underlying card PAN.
- **Tokenization** vs [PCI DSS](/pay/pci-dss.md) — Tokenization is a technique; PCI DSS is the compliance standard whose scope tokenization helps reduce by removing PANs from merchant systems.
