...
# Distinctions
- **Strong Customer Authentication** vs [3-D Secure](/pay/3-d-secure.md) — SCA is the regulatory requirement (the 'what' and 'why'); 3-D Secure is a technical authentication protocol commonly used to satisfy SCA for online card payments (the 'how').
