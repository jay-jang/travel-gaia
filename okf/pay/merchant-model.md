...
# Related
- [Agency Model](/pay/agency-model.md) — contrasts
...
# Distinctions
- **Merchant Model** vs [Agency Model](/pay/agency-model.md) — Under the merchant model the intermediary sets the price and is Merchant of Record; under the agency model the supplier does.
- **Merchant Model** vs [Net Rate](/hotel-dist/net-rate.md) — Net rates are the wholesale buying price the intermediary marks up under the merchant model.
