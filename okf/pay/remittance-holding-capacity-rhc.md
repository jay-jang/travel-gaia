...
# Distinctions
- **Remittance Holding Capacity (RHC)** vs [Remittance](/pay/remittance.md) — Remittance is the act of transferring collected funds to airlines; RHC is the ceiling on how much cash sales may remain unremitted before cash is blocked.
- **Remittance Holding Capacity (RHC)** vs [Settlement Cycle](/pay/settlement-cycle.md) — The settlement cycle sets when funds move; RHC limits how much risk can accumulate within that cycle, throttling cash sales in real time when breached.
