...
# Distinctions
- **VCC** vs [IATA EasyPay](/pay/iata-easypay.md) — IATA EasyPay is an IATA e-wallet exclusive to BSP ticket issuance, whereas a VCC is a general card-rail instrument used for many supplier payments.
