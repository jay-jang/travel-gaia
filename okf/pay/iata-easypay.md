...
# Related
- [BSP](/pay/bsp.md) — parent
- [E-ticket](/air-ticket/e-ticket.md) — related
- [EMD](/air-ticket/emd.md) — related
- [GDS](/standards/gds.md) — related

# Distinctions
- **IATA EasyPay** vs [VCC](/pay/vcc.md) — IATA EasyPay is an IATA-operated e-wallet limited to BSP ticket issuance, while a VCC is a general card-rail instrument usable for many supplier payments.
- **IATA EasyPay** vs [Chargeback](/pay/chargeback.md) — IATA EasyPay carries no chargeback risk for airlines because funds are pre-funded and blocked at issuance, unlike card payments.
