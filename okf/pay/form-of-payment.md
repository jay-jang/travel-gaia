...
# Distinctions
- **Form of Payment** vs [VCC](/pay/vcc.md) — A VCC is one specific instrument that can be used as a form of payment, whereas Form of Payment is the general ticketing element that records whichever instrument or method was used.
