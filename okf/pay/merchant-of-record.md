...
# Distinctions
- **Merchant of Record** vs [Agency Model](/pay/agency-model.md) — In the agency model the supplier is the Merchant of Record; the role describes who bears payment responsibility, not the commercial model itself.
- **Merchant of Record** vs [Merchant Model](/pay/merchant-model.md) — In the merchant model the intermediary becomes the Merchant of Record and shows on the cardholder's statement.
