...
- [Agency Credit Memo (ACM)](/air-ticket/agency-credit-memo-acm.md) — related

# Distinctions
- **Data Interchange Specifications Handbook (DISH)** vs [BSP](/pay/bsp.md) — BSP is the settlement system and institution; DISH is the technical data standard defining the file formats (RET/HOT) that BSP, GDSs and airlines exchange to operate it.
- **Data Interchange Specifications Handbook (DISH)** vs [Simplified Invoicing and Settlement (SIS)](/pay/simplified-invoicing-and-settlement-sis.md) — DISH governs agent-to-airline BSP reporting/hand-off files, while SIS standardizes airline-to-airline and supplier interline e-invoices for the clearing house; different settlement domains.
