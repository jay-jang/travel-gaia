...
- [Simplified Invoicing and Settlement (SIS)](/pay/simplified-invoicing-and-settlement-sis.md) — related
- [Settlement Cycle](/pay/settlement-cycle.md) — related
- [Remittance](/pay/remittance.md) — related

# Distinctions
- **CASS** vs [BSP](/pay/bsp.md) — CASS settles air-cargo accounts between airlines and freight forwarders/GSSAs, whereas BSP settles passenger ticket and EMD sales between airlines and travel agents.
- **CASS** vs [IATA Clearing House](/pay/iata-clearing-house.md) — CASS settles airline-to-forwarder cargo billings; the IATA Clearing House settles airline-to-airline (interline) obligations.
