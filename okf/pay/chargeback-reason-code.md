...
# Related
- [Chargeback](/pay/chargeback.md) — parent
...
# Distinctions
- **Chargeback Reason Code** vs [Chargeback](/pay/chargeback.md) — A chargeback is the dispute and forced reversal itself; the reason code is the standardized label that classifies that dispute and sets the evidence rules and deadlines.
