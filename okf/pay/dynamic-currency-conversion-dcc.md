...
# Distinctions
- **Dynamic Currency Conversion (DCC)** vs [ISO 4217 Currency Code](/codes/iso-4217-currency-code.md) — ISO 4217 is the standard that names and codes currencies; DCC is a commercial point-of-sale conversion service that chooses which currency the cardholder is billed in.
