...
- [Passive Segment](/air-ops/passive-segment.md) — related
- [Journey](/air-shop/journey.md) — related
- [Origin & Destination](/air-shop/origin-destination.md) — related

# Distinctions
- **ARNK** vs [Passive Segment](/air-ops/passive-segment.md) — ARNK marks a surface (non-flown) gap with no flight at all, whereas a passive segment is an informational air segment for a flight confirmed outside the active inventory.
- **ARNK** vs [Leg](/air-ops/leg.md) — ARNK is a non-flown placeholder bridging a surface break, while a leg is an actual physical flown hop of an aircraft.
