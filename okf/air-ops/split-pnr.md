...
- [Group PNR](/air-ops/group-pnr.md) — related
- [Record Locator](/air-ops/record-locator.md) — related
- [Reissue](/air-ticket/reissue.md) — related

# Distinctions
- **Split PNR** vs [Group PNR](/air-ops/group-pnr.md) — Splitting a PNR creates a new separate record for some passengers; a Group PNR is a single record holding many passengers under shared inventory. Splitting is often the action applied to part of a group, not the group structure itself.
