...
# Distinctions
- **Segment** vs [Leg](/air-ops/leg.md) — A segment is the marketed origin-to-destination flight under one flight number; a leg is a single physical takeoff-to-landing hop, so one segment can contain multiple legs.
