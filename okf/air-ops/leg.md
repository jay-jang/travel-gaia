...
# Related
- [Segment](/air-ops/segment.md) — child
- [Schedule Change](/air-partner/schedule-change.md) — related

# Distinctions
- **Leg** vs [Segment](/air-ops/segment.md) — A leg is one physical takeoff-to-landing hop, while a segment is the sold/marketed flight under one flight number that may span several legs.
