...
# Related
- [AIRIMP](/air-ops/airimp.md) — related
- [Passenger Name List / Additions and Deletions List (PNL/ADL)](/air-ops/pnl-adl.md) — related
- [Departure Control System (DCS)](/air-ops/departure-control-system-dcs.md) — related
- [Schedule Change](/air-partner/schedule-change.md) — related
- [Secure Flight](/customer/secure-flight.md) — related

# Distinctions
- **Type B Message** vs [EDIFACT](/standards/edifact.md) — Type B is the legacy teletype transport format with a constrained free-text line layout; EDIFACT is a structured, segment-based interchange syntax used by IATA PADIS for messages such as PNRGOV and electronic ticketing.
- **Type B Message** vs [AIRIMP](/air-ops/airimp.md) — Type B is the physical message format/transport, while AIRIMP is the procedural standard that specifies what a given reservation message must contain and when it may be sent.
