...
# Distinctions
- **Waitlist** vs [Overbooking](/air-shop/overbooking.md) — Overbooking is the carrier deliberately confirming more bookings than seats to offset no-shows; a Waitlist holds unconfirmed requests awaiting space. Waitlisted passengers are not confirmed, whereas overbooked passengers hold confirmed status that may exceed capacity.
