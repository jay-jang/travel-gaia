...
# Distinctions
- **RFM Segmentation** vs [Loyalty Tier Status](/customer/loyalty-tier-status.md) — Loyalty Tier Status is a program-defined standing a member earns through qualifying activity; RFM Segmentation is an internal analytic score a brand computes to group travelers by behavior, invisible to the customer.
