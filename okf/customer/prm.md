...
# Distinctions
- **PRM** vs [SSR](/air-ops/ssr.md) — PRM is the traveler category/need; SSR codes (e.g. WCHR, BLND) are the standardized messages used to request the corresponding assistance.
- **PRM** vs [OSI](/air-ops/osi.md) — PRM assistance requires action via an actionable SSR; OSI carries purely informational, non-actionable remarks.
