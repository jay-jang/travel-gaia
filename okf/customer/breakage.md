...
# Distinctions
- **Breakage** vs [Award Redemption](/customer/award-redemption.md) — Award Redemption is the act of a member spending points for a reward; Breakage is the accounting estimate of the points that will never be redeemed at all.
- **Breakage** vs [Mileage Accrual](/customer/mileage-accrual.md) — Mileage Accrual increases a member's balance and the program's liability; Breakage reduces the recognized liability by the share of that balance expected to expire unused.
