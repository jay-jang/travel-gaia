...
# Distinctions
- **Name Change** vs [Reissue](/air-ticket/reissue.md) — A name change is a data correction that may require ticket action; a reissue is the broader ticketing transaction (often triggered by such changes) that produces a new e-ticket.
