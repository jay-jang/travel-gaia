...
# Distinctions
- **Passenger Type Code** vs [RBD](/air-shop/rbd.md) — PTC classifies who the traveler is for fare eligibility; RBD is the booking class controlling seat inventory and class of service.
- **Passenger Type Code** vs [Fare Basis Code](/air-shop/fare-basis-code.md) — A PTC is an input that restricts which Fare Basis Codes a passenger can use; the Fare Basis Code identifies the specific priced fare.
