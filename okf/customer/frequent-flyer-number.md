...
# Distinctions
- **Frequent Flyer Number** vs [Frequent Flyer Program](/customer/frequent-flyer-program.md) — The number is the member's account ID; the program is the scheme that issues and governs that account.
- **Frequent Flyer Number** vs [SSR](/air-ops/ssr.md) — The Frequent Flyer Number is the data value; the FQTV SSR is the message element that carries it into a PNR.
