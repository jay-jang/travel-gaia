...
# Distinctions
- **Board Basis** vs [Rate Plan](/hotel-rate/rate-plan.md) — Board basis is one inclusion attribute carried within a rate plan; a rate plan also defines price, cancellation, and other conditions beyond meals.

# Citations
[1] OpenTravel Alliance — OpenTravel Specification (Hotel meal plan / meal codes)
