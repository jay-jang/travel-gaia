...
# Distinctions
- **Room Type** vs [Rate Plan](/hotel-rate/rate-plan.md) — Room type is the physical product (the room); rate plan is the price and conditions under which that room is sold.
- **Room Type** vs [Occupancy](/hotel-rate/occupancy.md) — Room type describes the room's attributes; occupancy describes how many guests stay in it, which can affect the applicable price.
