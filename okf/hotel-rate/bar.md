...
# Related
- [Rate Plan](/hotel-rate/rate-plan.md) — broader
- [Rate Parity](/hotel-rate/rate-parity.md) — related
- [ADR](/hotel-rate/adr.md) — related

# Distinctions
- **BAR** vs [Rate Plan](/hotel-rate/rate-plan.md) — BAR is one specific kind of rate plan (the best unrestricted public one); Rate Plan is the general category covering all offers.
- **BAR** vs [Rate Parity](/hotel-rate/rate-parity.md) — BAR is the rate itself; rate parity is the policy that this rate be consistent across channels.
- **BAR** vs [ADR](/hotel-rate/adr.md) — BAR is a published forward selling price; ADR is a realized average of prices actually achieved.
