...
# Distinctions
- **Occupancy** vs [RevPAR](/hotel-rate/revpar.md) — Occupancy rate is one factor (rooms sold vs available); RevPAR is revenue per available room and equals ADR multiplied by occupancy rate.
- **Occupancy** vs [ADR](/hotel-rate/adr.md) — ADR measures average price per occupied room; occupancy rate measures how full the hotel is — the two are independent inputs to RevPAR.
