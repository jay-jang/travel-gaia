...
- [Non-Last Room Availability (NLRA)](/hotel-rate/non-last-room-availability-nlra.md) — contrasts
- [GDS](/standards/gds.md) — related
- [Allotment](/hotel-rate/allotment.md) — related
- [Stop Sell](/hotel-rate/stop-sell.md) — related

# Distinctions
- **Last Room Availability (LRA)** vs [Non-Last Room Availability (NLRA)](/hotel-rate/non-last-room-availability-nlra.md) — LRA guarantees the negotiated rate down to the last sellable room; NLRA lets the hotel close that same negotiated rate once demand rises, even while rooms remain. LRA favours the buyer, NLRA favours the hotel's yield.
- **Last Room Availability (LRA)** vs [Allotment](/hotel-rate/allotment.md) — An allotment is a fixed block of rooms held for a partner; LRA is a guarantee about rate access against the hotel's whole live inventory, not a reserved block. LRA can apply even when no allotment exists.
- **Last Room Availability (LRA)** vs [Stop Sell](/hotel-rate/stop-sell.md) — A stop sell closes a rate or room from sale; an LRA guarantee specifically restrains the hotel from applying a stop sell to the negotiated rate while inventory remains, whereas NLRA permits exactly that.
