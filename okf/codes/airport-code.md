...
# Distinctions
- **Airport Code** vs [City Code](/codes/city-code.md) — An airport code identifies a single airport, whereas a city code identifies a metropolitan area that may aggregate several airports.
