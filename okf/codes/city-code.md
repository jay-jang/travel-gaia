...
# Distinctions
- **City Code** vs [Airport Code](/codes/airport-code.md) — A city code denotes a metropolitan area (possibly several airports); an airport code denotes one specific airport.
