...
# Distinctions
- **IATA Delay Codes** vs [IROPS](/air-partner/irops.md) — IROPS describes the operational situation of irregular operations (delays, cancellations, diversions); IATA delay codes are the standardized two-character labels that classify why a specific delay occurred within that situation.
