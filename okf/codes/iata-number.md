...
# Distinctions
- **IATA Number** vs [Pseudo City Code](/codes/pseudo-city-code.md) — An IATA Number is the agency's industry accreditation/settlement identifier (7-8 digits); a Pseudo City Code / Office ID is a GDS-internal subscriber identifier scoping bookings, fares, and privileges within one GDS.
- **IATA Number** vs [ARC](/pay/arc.md) — ARC is the U.S. settlement/accreditation body; the IATA Number is the IATA-assigned accreditation code used for BSP markets, though IATAN and ARC share location numbering.
