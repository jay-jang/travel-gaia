...
# Related
- [Airport Code](/codes/airport-code.md) — related
- [City Code](/codes/city-code.md) — related
- [IATA Code](/codes/iata-code.md) — related
- [IROPS](/air-partner/irops.md) — related

# Distinctions
- **Station Code** vs [Airport Code](/codes/airport-code.md) — A station code is the same IATA location code used operationally to mean an airline's location/presence; 'airport code' names the code itself as the identifier of an airport regardless of operational use.
- **Station Code** vs [City Code](/codes/city-code.md) — A station code may resolve to a single airport or, loosely, a metro area; a city code specifically denotes the metropolitan area aggregating multiple airports.
