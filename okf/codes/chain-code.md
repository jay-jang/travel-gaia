...
# Distinctions
- **Chain Code** vs [Airline Designator](/codes/airline-designator.md) — A chain code (2 letters) identifies a hotel chain/brand in distribution; an airline designator (2 characters) identifies an air carrier — different domains despite both being short codes.
